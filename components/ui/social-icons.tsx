...
const socials = [
  ...
  {
    name: "Instagram",
    href: "https://instagram.com/euroceram2002",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="size-[18px]">
...
export function SocialIcons() {
  ...
  return (
    <div className="relative w-fit flex items-center gap-0.5 px-1.5 py-1.5 rounded-2xl bg-neutral-950 border border-white/[0.08]">
